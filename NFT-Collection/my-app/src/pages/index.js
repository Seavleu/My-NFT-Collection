...
export default function Home() {
  ...
  /*Mint an NFT after the presale: ppl without whitelist address
   */
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    // If user not connected to the Goerli network throw an error
